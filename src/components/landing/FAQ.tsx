    ...
    <div id='accordion-collapse' data-accordion='collapse'>
      ...
      <div id='accordion-collapse-body-1' className='hidden' aria-labelledby='accordion-collapse-heading-1'>
        <div className='p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900'>
          <p className='mb-2 text-gray-500 dark:text-gray-400'>
            ...
            ullamcorper elementum. Sed urna magna, convallis ac justo at, dictum semper erat.
          </p>
      ...
      <div id='accordion-collapse-body-2' className='hidden' aria-labelledby='accordion-collapse-heading-2'>
        <div className='p-5 border border-b-0 border-gray-200 dark:border-gray-700'>
          <p className='mb-2 text-gray-500 dark:text-gray-400'>
            Etiam vehicula consectetur urna at vehicula. Curabitur accumsan eleifend nisl, in vestibulum tortor tristique quis. Nam
            eget dui et nunc rhoncus interdum a a urna.
          </p>
          <p className='text-gray-500 dark:text-gray-400'>
            Check out the{' '}
      ...
      <h2 id='accordion-collapse-heading-3'>
        <button
          ...
          <span>Etiam vehicula consectetur urna at vehicula.?</span>
          <svg
            data-accordion-icon
            className='w-3 h-3 rotate-180 shrink-0'
            aria-hidden='true'
